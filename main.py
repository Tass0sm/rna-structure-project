...
# seq_dict = get_seq_dict("/home/tassos/work/structure-project/cell/cell-alignment.sam")

sequence = pd.read_csv("./data/sequence.csv")

ctrl_phred_curve = plotting.get_curve(ctrl_phred_df, 300, 430, name="ctrl9kb", method="minimum")
